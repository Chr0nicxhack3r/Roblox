...
local v21 = nil;
local v22 = v20;
local v23 = 1907 - (957 + 950);
local v24 = 1 + 0;
local v25 = 148 - 98;
local v26 = nil;
local v27 = nil;
local v28 = v25;
local v29 = 1208 - (902 + 303);
local v30 = -v29;
local v31;
...
local function v34()
	local v60 = 214 - (22 + 192);
	while true do
		if (v60 == (683 - (483 + 200))) then
			if not v10 then
				return;
			end
...
local function v37(v64, v65, v66)
	if (v14 and v31 and v31['Notify']) then
		v31:Notify(v64, v65, v66 or (852 - (254 + 595)));
	end
end
local function v38(...)
	if v13 then
...
function telePlayerPOS(v70)
	...
	while true do
		...
		if (v71 == (1 - 0)) then
			...
			v73 = math.clamp(v72 / (926 - (118 + 688)), 48.15 - (25 + 23), 0.6 + 0);
			v71 = 1888 - (927 + 959);
		end
	end
end
	...
	while true do
		if (v77 == (732 - (16 + 716))) then
			...
			if (v75['KeyCode'] == Enum['KeyCode']['T']) then
				...
				local v135;
				while true do
					if (v134 == (98 - (11 + 86))) then
						v135 = v9['CFrame'] * CFrame.new(0 - 0, 285 - (175 + 110), v30);
						telePlayerPOS(v135);
						v134 = 4 - 2;
					end
					if (v134 == (0 - 0)) then
						if not v16 then
							local v150 = 1796 - (503 + 1293);
							while true do
								if (v150 == (0 - 0)) then
									v37(LUAOBFUSACTOR_DECRYPT_STR_0("\6\81\36\217\220\24\227\38", "\134\66\56\87\184\190\116"), LUAOBFUSACTOR_DECRYPT_STR_0("\24\56\27\190\26\255\40\58\50\48\5\251\13\238\45\48\44\62\27\175\89\226\50\117\51\55\15", "\85\92\81\105\219\121\139\65"), 3 + 0);
									return;
								end
							end
						end
...
task.spawn(function()
	while v19 do
		local v117 = 533 - (43 + 490);
		while true do
			if (v117 == (733 - (711 + 22))) then
				v43();
				task.wait(3 - 2);
				break;
			end
...
local v44 = {[LUAOBFUSACTOR_DECRYPT_STR_0("\160\33\176\79\156\107\20\155", "\113\226\77\197\42\188\32")]=function()
	...
	local v83 = 1744 - (1344 + 400);
	local v84;
	while true do
		if (v83 == (405 - (255 + 150))) then
	...
	local v89 = 1739 - (404 + 1335);
	local v90;
	while true do
		if (v89 == (406 - (183 + 223))) then
	...
	while true do
		if (v91 == (1 + 0)) then
			return v92['CFrame'] * CFrame.new(0 + 0, 342 - (10 + 327), 0 + 0);
		end
		if (v91 == (338 - (118 + 220))) then
...
v51:NewToggle(LUAOBFUSACTOR_DECRYPT_STR_0("\205\3\88\252\215\231\194\29\248\8\92\250", "\78\136\109\57\158\187\130\226"), LUAOBFUSACTOR_DECRYPT_STR_0("\27\49\248\243\50\58\185\242\43\44\237\254\51\127\238\240\50\52\185\226\46\58\252\245", "\145\94\95\153"), function(v98)
	local v99 = 0 - 0;
	while true do
		if (v99 == (1494 - (711 + 782))) then
			v37((v98 and LUAOBFUSACTOR_DECRYPT_STR_0("\216\195\21\215\66\178\249", "\215\157\173\116\181\46")) or LUAOBFUSACTOR_DECRYPT_STR_0("\17\189\152\243\216\57\177\143", "\186\85\212\235\146"), (v98 and LUAOBFUSACTOR_DECRYPT_STR_0("\241\145\19\251\61\174\81\209\193\19\240\56\236\84\199\133", "\56\162\225\118\158\89\142")) or LUAOBFUSACTOR_DECRYPT_STR_0("\111\21\197\170\38\152\85\22\128\171\43\203\93\7\204\170\38", "\184\60\101\160\207\66"), 5 - 2);
...
v51:NewSlider(LUAOBFUSACTOR_DECRYPT_STR_0("\210\46\230\69\126\99\134\209\50\226\89\127", "\166\130\66\135\60\27\17"), LUAOBFUSACTOR_DECRYPT_STR_0("\108\69\217\53\54\69\89\218\53\36\76\79\142\101\60\69\83\203\103\112\73\69\216\112\35", "\80\36\42\174\21"), 1919 - (580 + 1239), 2 - 1, v20, function(v100)
	local v101 = 0 + 0;
	while true do
		if (v101 == (1 + 0)) then
...
v51:NewSlider(LUAOBFUSACTOR_DECRYPT_STR_0("\119\99\126\12\51\155\66\74\115\97", "\45\61\22\19\124\19\203"), LUAOBFUSACTOR_DECRYPT_STR_0("\233\29\26\181\10\121\190\201\82\25\253\7\48\169\205\19\20\240\16\48\179\212\31\29\230", "\217\161\114\109\149\98\16"), 527 - 347, 1846 - (1045 + 791), v25, function(v104)
	local v105 = 0 - 0;
	while true do
		if (v105 == (0 - 0)) then
			v28 = v104;
...
v53:NewButton(LUAOBFUSACTOR_DECRYPT_STR_0("\239\212\34\89\63\88\201\197", "\55\187\177\78\60\79"), LUAOBFUSACTOR_DECRYPT_STR_0("\25\203\83\238\86\192\146\57\142\75\228\6\220\133\33\203\92\255\67\203\192\33\193\92\234\82\198\143\35", "\224\77\174\63\139\38\175"), function()
	local v107 = 505 - (351 + 154);
	local v108;
	local v109;
	while true do
		if (v107 == (1574 - (1281 + 293))) then
			if not v46 then
				local v136 = 266 - (28 + 238);
				while true do
					if (v136 == (0 - 0)) then
						v37(LUAOBFUSACTOR_DECRYPT_STR_0("\170\78\24\29\129\77\93\45\144\72\87\32", "\78\228\33\56"), LUAOBFUSACTOR_DECRYPT_STR_0("\254\114\183\2\150\203\62\177\11\138\193\109\183\67\132\142\106\183\15\128\222\113\160\23\197\194\113\177\2\145\199\113\188\67\131\199\108\161\23", "\229\174\30\210\99"), 1562 - (1381 + 178));
		...
		if (v107 == (3 - 2)) then
			if not v108 then
				local v137 = 0 + 0;
				while true do
					if (v137 == (470 - (381 + 89))) then
						v37(LUAOBFUSACTOR_DECRYPT_STR_0("\214\99\228\3\2", "\42\147\17\150\108\112"), LUAOBFUSACTOR_DECRYPT_STR_0("\38\168\59\126\235\225\11\230\57\122\235\237\31\169\63\107\167\251\10\170\40\124\243\225\0\168", "\136\111\198\77\31\135"), 3 + 0);
						return;
					end
				end
			end
		...
		if ((4 - 1) == v107) then
			v37(LUAOBFUSACTOR_DECRYPT_STR_0("\54\12\171\83\173\235\5\189\7\13", "\201\98\105\199\54\221\132\119"), LUAOBFUSACTOR_DECRYPT_STR_0("\141\9\143\36\18\58\190\173\9\135\97\22\58\236", "\204\217\108\227\65\98\85") .. v46, 1159 - (1074 + 82));
			break;
		end
		if (v107 == (3 - 1)) then
			if not v109 then
				local v138 = 1784 - (214 + 1570);
				while true do
					if (v138 == (1455 - (990 + 465))) then
						v37(LUAOBFUSACTOR_DECRYPT_STR_0("\106\198\249\224\60\207\76\215\181\195\45\201\82\198\241", "\160\62\163\149\133\76"), v46 .. LUAOBFUSACTOR_DECRYPT_STR_0("\150\174\2\59\131\208\175\24\33\199", "\163\182\192\109\79"), 2 + 1);
						return;
					end
				end
			end
...
v53:NewToggle("Directional Teleport (keybind 'T')", LUAOBFUSACTOR_DECRYPT_STR_0("\12\3\1\232\40\9\31\249\43\70\20\226\45\70\4\227\120\2\4\255\61\5\25\228\55\8\77\244\55\19\77\236\42\3\77\235\57\5\4\227\63", "\141\88\102\109"), function(v110)
	local v111 = 0 + 0;
	while true do
		if (v111 == (3 - 2)) then
			v38((v110 and LUAOBFUSACTOR_DECRYPT_STR_0("\151\90\216\117\25\41\92\206\189\82\198\48\14\56\89\196\163\92\216\100\90\56\91\192\177\95\207\116", "\161\211\51\170\16\122\93\53")) or LUAOBFUSACTOR_DECRYPT_STR_0("\223\167\160\45\248\186\187\39\245\175\190\104\239\171\190\45\235\161\160\60\187\170\187\59\250\172\190\45\255", "\72\155\206\210"));
			break;
		end
		if (v111 == (1726 - (1668 + 58))) then
			v16 = v110;
			v37((v110 and LUAOBFUSACTOR_DECRYPT_STR_0("\99\116\85\12\63\67\126", "\83\38\26\52\110")) or LUAOBFUSACTOR_DECRYPT_STR_0("\124\30\52\71\90\27\34\66", "\38\56\119\71"), (v110 and LUAOBFUSACTOR_DECRYPT_STR_0("\215\230\74\211\38\66\250\224\86\215\41\22\231\234\84\211\53\89\225\251\24\223\54\22\252\225", "\54\147\143\56\182\69")) or LUAOBFUSACTOR_DECRYPT_STR_0("\242\136\237\76\220\194\136\240\71\222\218\193\235\76\211\211\145\240\91\203\150\136\236\9\208\208\135", "\191\182\225\159\41"), 629 - (512 + 114));
			v111 = 2 - 1;
		end
	end
end);
v53:NewSlider(LUAOBFUSACTOR_DECRYPT_STR_0("\31\23\36\80\203\163\203\56\6\41\91\136\130", "\162\75\114\72\53\235\231"), LUAOBFUSACTOR_DECRYPT_STR_0("\164\51\83\162\85\3\158\124\66\237\65\21\141\46\64\162\27\11\130\124\87\246\70\6\159\117\4\246\91\7\204\40\65\238\86\18\131\46\80\162\94\13\154\57\87\162\74\13\153", "\98\236\92\36\130\51"), 62 - 32, 3 - 2, v29, function(v112)
	local v113 = 0 + 0;
	while true do
		if (v113 == (0 + 0)) then
			v30 = -v112;
			v38(LUAOBFUSACTOR_DECRYPT_STR_0("\128\16\30\191\70\188\188\63\170\24\0\250\65\161\166\36\165\23\15\191\5\187\176\36\228\13\3", "\80\196\121\108\218\37\200\213"), v112);
			break;
		end
	end
end);
local v54 = v47:NewTab(LUAOBFUSACTOR_DECRYPT_STR_0("\51\118\22\107\66\0\141\19", "\234\96\19\98\31\43\110"));
local v55 = v54:NewSection(LUAOBFUSACTOR_DECRYPT_STR_0("\50\23\87\202\169", "\235\102\127\50\167\204\18"));
v55:NewDropdown(LUAOBFUSACTOR_DECRYPT_STR_0("\96\168\246\40\4\55\95\180\231\99\80\38\85\172\240", "\78\48\193\149\67\36"), LUAOBFUSACTOR_DECRYPT_STR_0("\3\27\140\29\66\36\94\148\16\68\61\27\192\30\78\34\94\148\16\68\112\57\181\49", "\33\80\126\224\120"), v31.GetThemes(), function(v114)
	local v115 = 0 + 0;
	while true do
		if (v115 == (0 - 0)) then
			v31:SetTheme(v114);
			task.defer(function()
				...
				while true do
					if (v127 == (1469 - (1269 + 200))) then
						v37(LUAOBFUSACTOR_DECRYPT_STR_0("\216\160\6\201\89\172\139\11\197\82\235\173\7", "\60\140\200\99\164"), v114 .. LUAOBFUSACTOR_DECRYPT_STR_0("\199\245\20\54\174\142\241\0", "\194\231\148\100\70"), 5 - 2);
						v38(LUAOBFUSACTOR_DECRYPT_STR_0("\114\68\196\174\243\136\69\68\192\173\241\205\66\12\213\172", "\168\38\44\161\195\150"), v114);
						break;
					end
				end
			end);
...
v55:NewLabel(LUAOBFUSACTOR_DECRYPT_STR_0("\168\245\134\115\112\167\246\37\136\243\149\54\5\193\236\86\144\238\135\101\35\168\154\19\134\232\161\121\62\252\164\25\140\188\202\90\19\220\132\58\201", "\118\224\156\226\22\80\136\214"));
v31:Notify(LUAOBFUSACTOR_DECRYPT_STR_0("\113\251\90\131\71\253\74", "\224\34\142\57"), LUAOBFUSACTOR_DECRYPT_STR_0("\253\175\215\141\125\248\94\22\253\175\192\220\103\177\78\27\221\164\192\206\96\247\72\2\210\190\133\209\124\240\89\11\218\230", "\110\190\199\165\189\19\145\61"), 818 - (98 + 717));
...
game:GetService(LUAOBFUSACTOR_DECRYPT_STR_0("\46\176\144\25\57\189\137\25\41\176\154\27\19\182\141", "\109\122\213\232")):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\218\242\186\36\205\255\163\62\224\242\174\35", "\80\142\151\194")):WaitForChild(LUAOBFUSACTOR_DECRYPT_STR_0("\49\228\79\107\6\200\114\94\2\202", "\44\99\166\23")):SendAsync(LUAOBFUSACTOR_DECRYPT_STR_0("\85\183\37\57\32\176\60\227\33\51\115\163\125\250\44\120", "\196\28\151\73\86\83"));
local function v56()
	local v116 = 826 - (802 + 24);
	while true do
		if ((0 - 0) == v116) then
			v19 = false;
			v16 = false;
		...
		if (v116 == (1 + 1)) then
			...
			if (v31 and v31['Notify'] and v14) then
				v31:Notify(LUAOBFUSACTOR_DECRYPT_STR_0("\198\13\37\31\131\92\29\114", "\22\147\99\73\112\226\56\120"), LUAOBFUSACTOR_DECRYPT_STR_0("\139\118\240\252\157\172\53\241\253\152\172\53\230\250\154\182\53\225\249\136\185\123\238\236", "\237\216\21\130\149"), 1 + 2);
			end
			if (v31 and v31['_Shutdown']) then
				v31:_Shutdown();
			end
			v38(LUAOBFUSACTOR_DECRYPT_STR_0("\177\77\77\86\160\221\30\151\64\83\80\177\205\91\134\14\92\83\181\200\80\142\87\17", "\62\226\46\63\63\208\169"));
			break;
		end
	end
end
