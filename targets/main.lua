...
function telePlayerPOS(v63)
	...
	while true do
		...
		if (v64 == (754 - (239 + 514))) then
			v65 = (v9['Position'] - v63['Position'])['Magnitude'];
			v66 = math.clamp(v65 / (43 + 77), 1329.15 - (797 + 532), 0.6 + 0);
			v64 = 1 + 1;
		end
	end
end
v12[LUAOBFUSACTOR_DECRYPT_STR_0("\126\193\247\83\89\230\137\85\198\228\90\110\247\140\95\216\234\68\78", "\224\58\168\133\54\58\146")] = v3['InputBegan']:Connect(function(v68, v69)
	local v70 = 0 - 0;
	while true do
		if (v70 == (1202 - (373 + 829))) then
			if v69 then
				return;
			end
			if (v68['KeyCode'] == Enum['KeyCode']['T']) then
				local v105 = 731 - (476 + 255);
				local v106;
				while true do
					if (v105 == (1132 - (369 + 761))) then
					...
					if (v105 == (0 + 0)) then
						if not v16 then
							local v118 = 0 - 0;
							while true do
								if (v118 == (336 - (144 + 192))) then
									v36(LUAOBFUSACTOR_DECRYPT_STR_0("\255\130\2\244\187\208\202\223", "\175\187\235\113\149\217\188"), LUAOBFUSACTOR_DECRYPT_STR_0("\24\166\147\73\224\109\113\51\161\128\64\163\109\125\48\170\145\67\241\109\56\53\188\193\67\229\127", "\24\92\207\225\44\131\25"), 219 - (42 + 174));
									return;
								end
							end
						end
...
v44:NewSlider(LUAOBFUSACTOR_DECRYPT_STR_0("\131\36\14\229\213\73\243\27\31\249\213\95", "\59\211\72\111\156\176"), LUAOBFUSACTOR_DECRYPT_STR_0("\102\136\244\109\72\134\240\57\14\147\235\40\14\151\239\44\87\130\241\109\67\136\245\40\93", "\77\46\231\131"), 2075 - (1913 + 62), 1 + 0, v19, function(v77)
	local v78 = 0 - 0;
	while true do
		if ((1933 - (565 + 1368)) == v78) then
			v21 = v77;
			v32();
			v78 = 3 - 2;
		end
		if (v78 == (1662 - (1477 + 184))) then
...
v44:NewToggle(LUAOBFUSACTOR_DECRYPT_STR_0("\107\25\48\170\253\181\5\112\91\26\33", "\58\46\119\81\200\145\208\37"), LUAOBFUSACTOR_DECRYPT_STR_0("\14\130\49\174\165\184\118\40\153\35\184\166\176\118\33\153\61\188\233\173\57\60\137\34", "\86\75\236\80\204\201\221"), function(v79)
	...
	while true do
		...
		if (v80 == (1 - 0)) then
			v36((v79 and LUAOBFUSACTOR_DECRYPT_STR_0("\87\79\118\135\242\142\118", "\235\18\33\23\229\158")) or LUAOBFUSACTOR_DECRYPT_STR_0("\116\179\210\186\82\182\196\191", "\219\48\218\161"), (v79 and LUAOBFUSACTOR_DECRYPT_STR_0("\206\100\113\89\155\95\239\243\116\110\9\222\65\225\230\125\121\77", "\128\132\17\28\41\187\47")) or LUAOBFUSACTOR_DECRYPT_STR_0("\43\39\11\42\29\17\61\17\63\79\65\54\15\41\92\3\62\3\62", "\61\97\82\102\90"), 8 - 5);
...
v44:NewSlider(LUAOBFUSACTOR_DECRYPT_STR_0("\29\78\210\57\192\102\81\32\94\205", "\62\87\59\191\73\224\54"), LUAOBFUSACTOR_DECRYPT_STR_0("\207\13\237\137\239\11\253\193\167\22\242\204\167\18\246\200\254\7\232\137\237\23\247\217\244", "\169\135\98\154"), 484 - (244 + 60), 8 + 2, v24, function(v81)
	local v82 = 476 - (41 + 435);
	while true do
		if (v82 == (1001 - (938 + 63))) then
			v27 = v81;
			v34();
			break;
		end
...
v48:NewDropdown(LUAOBFUSACTOR_DECRYPT_STR_0("\5\189\136\249\154\44\187\158\224\154\33\188\142\255\223", "\186\85\212\235\146"), LUAOBFUSACTOR_DECRYPT_STR_0("\241\132\26\251\58\250\24\214\137\19\243\60\174\94\205\147\86\234\49\235\24\229\180\63", "\56\162\225\118\158\89\142"), v30.GetThemes(), function(v87)
	local v88 = 1092 - (975 + 117);
	while true do
		if (v88 == (1875 - (157 + 1718))) then
			v30:SetTheme(v87);
			task.defer(function()
				local v98 = 0 + 0;
				while true do
					if (v98 == (0 - 0)) then
						v36(LUAOBFUSACTOR_DECRYPT_STR_0("\104\13\197\162\39\152\127\13\193\161\37\221\88", "\184\60\101\160\207\66"), v87 .. LUAOBFUSACTOR_DECRYPT_STR_0("\113\131\108\172\61\139\121\184", "\220\81\226\28"), 10 - 7);
...
v30:Notify(LUAOBFUSACTOR_DECRYPT_STR_0("\209\55\228\95\126\98\213", "\166\130\66\135\60\27\17"), LUAOBFUSACTOR_DECRYPT_STR_0("\103\66\220\37\62\77\73\214\86\56\65\75\218\53\35\81\73\205\112\35\87\76\219\121\60\93\10\194\122\49\64\79\202\52", "\80\36\42\174\21"), 1021 - (697 + 321));
v37(LUAOBFUSACTOR_DECRYPT_STR_0("\125\19\37\115\94\4\119\118\65\17\51\127\74\80\36\111\77\19\50\105\93\22\34\118\66\9\121", "\26\46\112\87"));
local function v49()
	local v89 = 0 - 0;
	while true do
		if (v89 == (0 - 0)) then
		...
		if (v89 == (5 - 3)) then
			if (v30 and v30['Notify'] and v14) then
				v30:Notify(LUAOBFUSACTOR_DECRYPT_STR_0("\140\45\167\123\190\187\64\176", "\212\217\67\203\20\223\223\37"), LUAOBFUSACTOR_DECRYPT_STR_0("\137\142\186\219\170\153\232\193\178\152\188\146\190\130\191\220\250\142\164\215\187\131\164\203", "\178\218\237\200"), 1230 - (322 + 905));
			end
			if (v30 and v30['_Shutdown']) then
				v30:_Shutdown();
			end
			v37(LUAOBFUSACTOR_DECRYPT_STR_0("\133\182\244\217\166\161\166\197\184\185\233\209\178\176\226\144\181\185\227\209\184\185\255\158", "\176\214\213\134"));
			break;
		end
	end
end
